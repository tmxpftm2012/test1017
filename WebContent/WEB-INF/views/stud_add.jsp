...
<body>
	<div class="container">
		...
		<!-- 추가를 위한 HTML 폼 시작 -->
		<form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/stud_add_ok.do">
		  ...
		  <div class="form-group">
		    <label for="profno" class="col-sm-2 control-label">교수이름</label>
		    <div class="col-sm-10">
		      <select name="deptno" class="form-control">
		      	<option value="">---- 교수이름을 선택하세요 ----</option>
		      	<c:forEach var="item" items="${prof_list}" varStatus="status">
					<!-- 그냥 k를 호출할 경우 toString()가 호출된다. -->
